...
function CyberNPC.NPCReplyIntroNegativeLinesRandomLines(lifepath)
    ...
    if lifepath == 'Corporate' then
        return CyberNPC.NPCByeCorpoHostileLinesRandomLine()
    elseif lifepath == "Nomad" then
        return CyberNPC.NPCByeNomadHostileLinesRandomLine()
    elseif lifepath == "StreetKid" then
        return CyberNPC.NPCByeStreetKidHostileLinesRandomLine()
    end
end
...
CyberNPC.NPCByeCorpoHostileLines = {
    "Go away, corpo.",
    "Leave now, suit.",
    "We don't want you here.",
    "Stay out of our streets.",
    "Don't come near me, corpo.",
    "Get lost, executive.",
    "Mind your business and leave.",
    "Pack up and go back to your tower.",
    "Not welcome here, suit.",
    "I said move, corpo.",
    "Keep walking, executive.",
    "Don't show your face here again.",
    "You don't belong here, corpo.",
    "Step off, suit.",
    "Go home, executive.",
    "Walk away and don't return.",
    "Clear out, corpo.",
    "Don't make me call you out, suit.",
    "This is not your place, executive.",
    "Leave before someone notices you're a corpo.",
    "Back off, corpo.",
    "Move along, suit.",
    "Get out of my way, executive.",
    "Don't loiter here, corpo.",
    "Scram, suit.",
    "Beat it, executive.",
    "Clear the area, corpo.",
    "Go find your high-rise, suit.",
    "Don't hang around, corpo.",
    "Exit the block, corpo.",
    "Take your kind elsewhere, suit.",
    "Disappear, corpo scum.",
    "Not your neighborhood, corpo.",
    "Vanish, suit.",
    "Quit staring, executive.",
    "Fold up your badge and go, corpo.",
    "Don't test me, suit.",
    "Head back to the tower, executive.",
    "Leave the zone, corpo.",
    "Shoo, suit.",
    "Out now, corpo.",
    "Go on, suit.",
    "Off this block, executive.",
    "Don't linger, corpo.",
    "Hit the road, suit.",
    "Move your feet, executive.",
    "Take a hike, corpo.",
    "Beat a retreat, suit.",
    "Exit now, executive.",
    "Relocate yourself, corpo.",
    "Go home, suit.",
    "Clear off, executive.",
    "Scram now, corpo.",
    "Step away, suit.",
    "Go find another street, executive.",
    "Time to leave, corpo.",
    "Disappear now, suit.",
    "Push off, executive.",
    "Take your leave, corpo.",
    "Leave this block, suit.",
    "Go.",
    "Get out.",
    "Move corpo.",
    "Leave corpo scum.",
    ...
    "Back to your tower.",
    "Out of here.",
    "I don't talk to corpos.",
    "Head out.",
    "Go find another place.",
    "Now move.",
    "Get lost now.",
    "Pack up and leave.",
    "Move along now, corpo.",
    "Go on, clear off, suit.",
    "Don't stand here, executive.",
    "Take your presence elsewhere, corpo.",
    "Leave this street, suit.",
    "Not a place for you, executive.",
    "Go find your own crowd, corpo.",
    "Don't block the way, suit.",
    "Step back and go, executive.",
    "Exit the area now, corpo.",
    "Head home, suit.",
    "Go somewhere else, executive.",
    "Don't loiter here, corpo.",
    "Pack it up and leave, suit.",
    "Go away, and stay away, executive.",
    "Move — now, corpo.",
    "Go do your business somewhere else, suit.",
    "This isn't for you, executive.",
    "Take your suit and leave, corpo.",
    "Go before things get ugly, suit.",
    "Not welcome, corpo.",
    "This street's closed to suits.",
    "Go find your skyscraper.",
    "Don't bring your kind here.",
    "You should leave now.",
    "Take your badge elsewhere.",
    "We don't accept execs here.",
    "Vacate this area, corpo.",
    "Your presence is unwanted.",
    "Move yourself along, suit.",    
    "Go on, leave the neighborhood.",
    "Do us a favor and depart.",
    "Head back to where you came from.",
    "Find another block, corpo.",
    "Your business isn't needed here.",
    "Disappear from sight, suit.",
    "Make yourself scarce, executive.",
    "Relocate away from here, corpo.",
    "Step out of our way, suit.",
    "Not wanted here, corpo.",
    "Go return to your office.",
    "Take your suit and leave.",
    "Don't walk these alleys, executive.",
    "Please vacate the sidewalk, corpo.",
    "Remove yourself from this block, suit.",
    "You should head back upstairs.",
    "Leave the neighborhood now, executive.",
    "Go find another workplace, corpo.",
    "Do everyone a favor and go, suit.",
    "This corner isn't for you, corpo.",
    "Pack up and head out, corpo.",
    "Walk away from here, suit.",
    "Go back to your floor, executive.",
    "Disappear from this street, corpo.",
    "Move away from this area, suit.",
    "Go somewhere appropriate, arasaka boot licker.",
    "Get off this pavement, corpo.",
    "Go return to your arasaka floor, suit.",
    "Leave this quarter, executive.",
    "I don't talk to corpos.",
    "I'm not talking to a corpo.",
    "I don't deal with corp scum.",
    "Save your words, corpo.",
    "I refuse to talk to you.",
    "I'm done speaking to execs.",
    "Don't expect me to answer, corpo.",
    "I won't listen to a suit.",
    "My ears are closed to corpos.",
    "I don't waste breath on executives.",
    "Not a word for corp scum.",
    "I ignore corpos.",
    "No conversation with a corpo.",
    "I won't speak to your kind.",
    "Don't speak to me, corpo.",
    "I'm deaf to suit talk.",
    "I refuse to hear corpos.",
    "Your voice doesn't reach me, corpo.",
    "I won't entertain executives.",
    "Don't try to talk to me, corpo.",
    "I don't answer corpos.",
    "Not listening to any suit.",
    "Corpos get no response from me.",
    "I shut my mouth for execs.",
    "Corpo words bounce off me.",
    "I won't dignify you with talk.",
    "No reply for corporate trash.",
    "My lips stay sealed for corpos.",
    "I give you silence, suit.",
    "I cut off all corpo chatter.",
    "Won't waste a syllable on you.",
    "I stonewall corpos.",
    "Corpo pleas fall on deaf ears.",
    "I blank out when I see a suit.",
    "Silence for corporate types.",
    "I turn away from exec talk.",
    "I treat corpos like background noise.",
    "I refuse any exchange with suits.",
    "I keep quiet around corporate scum.",
    "No words for your kind.",
    "Do you wanna know what I do with your kind?",
    "Fuck off, corpo scum.",
    "Piss off, suit.",
    "Get the hell out, corpo.",
    "Screw off, executive.",
    "Fuck you, suit.",
    "Shove off, corpo.",
    "Bugger off, exec.",
    "Get lost, corpo filth.",
    "Eat shit, suit.",
    "Fuck right off, executive.",
    "Clear off, corpo scum.",
    "Take a hike and don't come back, suit.",
    "Back off or I will, corpo.",
    "Leave or I'll make you leave, suit.",
    "Don't test me, corpo scum.",
    "Go to hell, suit.",
    "Piss right off, executive.",
    "I'll toss you out, corpo.",
    "Fuck off and disappear, suit.",
    "Get the fuck away, corpo.",
    "Fuck off and don't show your face, corpo.",
    "Piss off and take your arasaka suit with you.",
    "Get the fuck out of my sight, corpo.",
    "Fuck off, go rot in your tower, corpo.",
    "Piss off, don't come near me again, suit.",
    "Get lost, corpo, before I make you.",
    "Fuck off now, exec, or else.",
    "Piss right off, you corporate pest.",
    "Get the hell away from me, corpo.",
    "Fuck off, and don't breathe the same air, suit.",
    "Piss off, corpo! disappear.",
    "Get outta here, corpo, or I'll act.",
    "Fuck off, corpo scum, before I do more than talk.",
    "Piss off now, or you'll regret it, suit.",
    "Get gone, corpo, this isn't for you.",
    "Fuck off and vanish, executive.",
    "Piss off, suit, or taste trouble.",
    "Get the fuck out, corpo, fast.",
    "Fuck off. I won't warn you again, suit.",
    "Piss off and never come back, executive."
}
function CyberNPC.NPCByeCorpoHostileLinesRandomLine()
    local line = math.random(#(CyberNPC.NPCByeCorpoHostileLines))
    return CyberNPC.NPCByeCorpoHostileLines[line]
end

CyberNPC.NPCByeNomadHostileLines = {
    "Fuck off, nomad.",
    "Piss off, drifter.",
    "Get the hell out, caravan trash.",
    "Screw off, wanderer.",
    "Fuck you, road rat.",
    "Shove off, dustbag.",
    "Bugger off, highway scum.",
    "Get lost, sand rat.",
    "Eat shit, nomad.",
    "Fuck right off, drifter.",
    "Clear off, caravan scum.",
    "Take a hike and don't come back, wanderer.",
    "Back off or I will, road dog.",
    "Leave or I'll make you leave, drifter.",
    "Don't test me, nomad scum.",
    "Go to hell, rover.",
    "Piss right off, caravan rat.",
    "I'll toss you out, nomad.",
    "Fuck off and disappear, wanderer.",
    "Get the fuck away, road rat.",
    "Beat it, nomad.",
    "Scram, drifter.",
    "Clear off, road trash.",
    "Get gone, caravan scum.",
    "Move along, wanderer.",
    "Push off, sand rat.",
    "Vamoose, road dog.",
    "Get out, dustbag.",
    "Take off, rover.",
    "Go rot on the dunes, nomad.",
    "Bugger off, caravan rat.",
    "Fuck right off, road rat.",
    "Piss off, wanderer.",
    "Get the hell outta here, drifter.",
    "Leave town, nomad.",
    "Disappear, road scum.",
    "Back to your convoy, rover.",
    "Don't come back, drifter.",
    "Off with you, nomad.",
    "Get lost and stay lost, caravan trash.",
    "Beat it, sand-gnawer.",
    "Scram, dune-rat.",
    "Clear off, trailer-trash.",
    "Get gone, rust-blood.",
    "Move along, gutter-runner.",
    "Push off, scrap-face.",
    "Vamoose, road-hound.",
    "Get out, tarp-skulker.",
    "Take off, axle-junkie.",
    "Go rot with your convoy, grit-mouth.",
    "Bugger off, chrome-mangler.",
    "Fuck right off, dust-licker.",
    "Piss off, haul-skulker.",
    "Get the hell outta here, fence-rider.",
    "Leave town, rig-wrangler.",
    "Disappear, nomad-bastard.",
    "Back to your pits, tow-ghoul.",
    "Don't come back, dune-skulker.",
    "Off with you, caravan-maggot.",
    "Get lost and rust away, yard-rat.",
    "Clear off, sand-packer.",
    "Beat it, scrap-hustler.",
    "Scram, axle-fugitive.",
    "Push off, tarp-rummager.",
    "Move along, rust-hopper.",
    "Get out, wheel-gnome.",
    "Take off, grease-monger.",
    "Vamoose, trailer-gnat.",
    "Go rot, bolt-scraper.",
    "Bugger off, hitch-crawler.",
    "Get lost, chassis-rat.",
    "Back off, hub-skulker.",
    "Disappear, lug-wretch.",
    "Leave, axle-swindler.",
    "Clear the road, fuel-scavenger.",
    "Get gone, bedroll-bleeder.",
    "Scram, crate-monger.",
    "Beat it, rig-hollow.",
    "Push off, tarp-ghoul.",
    "Move on, grease-vagrant",
    "Move along, nomad.",
    "Leave this area.",
    "Head back to the convoy.",
    "This spot's not for you.",
    "Keep moving, friend.",
    "Give me some space, nomad.",
    "Take your things and ride along.",
    "Try another route, nomad.",
    "Stay on the road, don't linger.",
    "I prefer you pass by.",
    "Head back to your rigs.",
    "Don't settle here.",
    "Find somewhere else to stop.",
    "Keep to your tribe.",
    "Step off the block.",
    "Do us a favor and move along.",
    "Don't make a scene here.",
    "Go on, keep on moving.",
    "Respect the area and leave.",
    "Pack up and carry on.",
    "Move on, nomad.",
    "Get out of the way.",
    "Head back to your lane.",
    "This isn't a stopping place.",
    "Keep to the outskirts.",
    "Walk on, don't block traffic.",
    "Go back to the convoy line.",
    "Shift along, now.",
    "Relocate yourself.",
    "Clear the path.",
    "Make tracks, nomad.",
    ...
    "Leave this stretch.",
    "Move off the pavement.",
    "Relocate your camp.",
    "Go find another pullout.",
    "Continue on your way.",
    "Move on, nomad.",
    "Get out of the way.",
    "Head back to your lane.",
    "This ain't a stopping place.",
    "Keep to the outskirts.",
    "Walk on, don't block traffic.",
    "Go back to the convoy line.",
    "Shift along, now.",
    ...
    "Keep to your side of the street.",
    "Leave this stretch.",
    "Move off the pavement, nomad.",
    "Relocate your camp.",
    "Go find another pullout.",
    "Continue on your way.",
    "Step aside, nomad.",
    "Move along! You're beneath this district.",
    "Go back to your rigs; this is higher ground.",
    "Don't loiter here with the rest of you.",
    "Take your dirt elsewhere.",
    "Keep walking, this isn't for your kind.",
    "Find your convoy and stay there.",
    "Don't look up; just move.",
    "Head back to the junkyard.",
    "We don't mix with road trash here.",
    "Carry on, and try not to stare.",
    "Go wait with the others down below.",
    "Leave the streets to people who matter.",
    "Move on before someone notices you.",
    "Keep your distance and your grime.",
    "Step off, we have no use for you here.",
    "Return to your convoy and keep quiet.",
    "Don't pretend you belong up here.",
    "Go on, be gone — this isn't your place.",
    "Back to the dunes with you.",
    "Step aside, you smell like five days on the road.",
    "Move along, that stench gives you away.",
    "Go back to your rigs, diesel and sweat do not belong here.",
    "Do not loiter here smelling of grease and old tarps.",
    "Take your dirt and your funk elsewhere.",
    "Keep walking, your motor oil smell makes people nervous.",
    "Find your convoy, the campfire odor follows you.",
    "Do not look up, just move, you reek of axle grease.",
    "Head back to the junkyard with that wet tarp smell.",
    "We do not mix with road trash that reeks of fuel.",
    "Carry on, the smell of stale food gives you away.",
    "Go wait with the others down below, you smell like camp smoke.",
    "Leave the streets to people who matter, your jacket reeks of oil.",
    "Move on before someone notices that cloud of road grime.",
    "Keep your distance, you smell like cheap booze and grease.",
    "Step off, that odor of dust and damp canvas is enough.",
    "Return to your convoy and keep quiet, your stench precedes you.",
    "Do not pretend you belong up here with that smell of rust and sweat.",
    "Go on, be gone, the smell of engine grease makes this place worse.",
    "Back to the dunes with you, you bring the smell of the dumps.",
    "Step aside, you stink of the road.",
    "Move on, your smell gives you away.",
    "Go back to your rigs, you reek.",
    "Do not loiter, you smell like grease.",
    "Take your funk elsewhere.",
    "Keep walking, you smell of diesel.",
    "Find your convoy, you smell of smoke.",
    "Do not look up, just go, you reek of oil.",
    "Head back to the junkyard, you smell damp tarp.",
    "We do not mix with fuel stench.",
    "Carry on, your odor says nomad.",
    "Go wait with the others, you smell of campfire.",
    "Leave this street, your jacket reeks.",
    "Move on, your grime is obvious.",
    "Keep your distance, you smell like booze and grease.",
    "Step off, that dust smell is enough.",
    "Return to your convoy, your stench comes first.",
    "Do not pretend you belong up here, you smell of rust.",
    "Go away, your engine smell ruins this place.",
    "Back to the dunes, you bring the dumps' smell."
}
function CyberNPC.NPCByeNomadHostileLinesRandomLine()
    local line = math.random(#(CyberNPC.NPCByeCorpoHostileLines))
    return CyberNPC.NPCByeCorpoHostileLines[line]
end

CyberNPC.NPCByeStreetKidHostileLines = {
    "Move along, streetkid.",
    ...
    "Clear off, kid.",
    "Go find your crew.",
    "Don't loiter on this block.",
    "Beat it, street trash.",
    "Keep to your alley.",
    "Step away, kid.",
    "Don't make trouble here.",
    "Leave before someone notices you.",
    "Go on, move.",
    "Stay out of our way.",
    "Head back to where you belong.",
    "Don't stick around, kid.",
    "Get lost and stay lost.",
    "Stop hustling here, kid.",
    "Quit pickpocketing on this block.",
    "Don't spray your tags on these walls.",
    "Keep your tech-swaps off my corner.",
    "No shady deals on my street.",
    "Don't run your ripperdoc scams here.",
    "Quit selling knockoff cyberware nearby.",
    "Keep your distro drops away from here.",
    "Don't flash your chrome around here.",
    "Stop skimming wallets on this corner.",
    "Don't recruit kids for your gang here.",
    "Keep your drag races off the avenue.",
    "Don't set up your chop-shops here.",
    "Stop mugging people on this block.",
    "Quit running confidence tricks near me.",
    "Don't sell illegal eddies here.",
    "Stop running data heists on my route.",
    "Don't hustle tourists in front of shops.",
    "Quit recruiting for street fights here.",
    "Keep your illicit trades out of sight.",
    "Don't run your black market here.",
    "Quit lifting creds from patrons.",
    "Stop jacking people's implants nearby.",
    "Don't loiter with your crew at the rack.",
    "Keep your barter stalls off this block.",
    "Stop selling bootleged software here.",
    "Don't use my street for chop-swap meets.",
    "Quit running courier drops in front of shops.",
    "Don't bring your turf wars to this corner.",
    "Stop peddling stolen hardware here.",
    "Don't run fake IDs on my beat.",
    "Quit hustling rides from passersby.",
    "Don't set up a chop-shop by the alley.",
    "Stop recruiting kids for smash-and-grabs here.",
    "Don't run your fight bets on this pavement.",
    "Quit tagging storefronts with your crew's name.",
    "Don't run data-sells at the curb.",
    "Stop scamming tourists with phony guides.",
    "Don't use this strip for pick-and-run jobs.",
    "Quit selling hacked upgrades on my corner.",
    "Quit hustling here, or I call it in.",
    "Stop lifting pockets on my block.",
    "Don't tag these walls with your crap.",
    "Keep your tech swaps off my corner, got it?",
    "No shady deals under my windows.",
    "Don't run ripper scams near my shop.",
    "Quit selling fake cyberware to locals.",
    "Take your distro drops somewhere else.",
    "Don't show off chrome where people work.",
    "Stop nicking wallets from honest folks.",
    "Don't drag kids into your crew here.",
    "Keep your drag races off this street.",
    "Don't open a chop-shop by my alley.",
    "Stop mugging people walking past.",
    "Quit running quick cons on my watch.",
    "Don't peddle stolen creds here.",
    "Stop hauling stolen data through this lane.",
    "Don't hustle tourists at the storefronts.",
    "Quit staging fights on my pavement.",
    "Keep your illegal trades out of sight, or leave.",
    "You're a streetkid.",
    "Streetkids don't belong here.",
    "Keep your hands to yourself.",
    "Don't act like you own this block.",
    "Go back to your corner.",
    "We see you for what you are.",
    "Stop playing tough.",
    "Don't bring your street business here.",
    "Keep your crew out of sight.",
    "We don't need streetkids causing trouble.",
    "Stay out of grown people's way.",
    "Don't try to boss us around.",
    "Your kind pick pockets, not fights.",
    "Keep your patch clean.",
    "Move on before someone notices.",
    "Don't sell your tricks here.",
    "Stay with your crowd.",
    "We don't want street drama.",
    "Take your hustle elsewhere.",
    "Don't tempt trouble.",
    "Okay, okay, you're a streetkid, I get it.",
    "Fine, stay here, I don't want trouble.",
    "Alright, keep your distance, I don't want to start anything.",
    "Yeah, you look dangerous, I'll move.",
    "I see you, I'll leave you be.",
    "No fights, alright? I'll back off.",
    "Relax, I'm not asking for trouble.",
    "I don't want to mess with you, I'm going.",
    "Alright, you win this block, I'm out.",
    "I know better than to push you, leaving now.",
    "Don't need trouble, I'll go.",
    "I can tell you handle yourself, stepping off.",
    "Easy, I'll find another route.",
    "You look armed, I'm not sticking around.",
    "I hear you, moving along.",
    "No need to rough me up, I'll go.",
    "I don't want your heat, leaving.",
    "I don't want to test that temper, taking off.",
    "Okay, okay, I hear you loud and clear.",
    "I'm going, keep your patch.",
    "I don't want to talk to a streetkid.",
    "Not talking to you, street kid.",
    "Save your breath, I'm not listening to streetkids.",
    "I won't answer a streetkid.",
    "No conversation with a streetkid, go.",
    "Don't speak to me, you're a streetkid.",
    "I'm not engaging with your kind, move on.",
    "I refuse to talk to a streetkid.",
    "Keep your distance, I'm silent with streetkids.",
    "No words for a streetkid, leave.",
    "Don't ask me anything, you're a streetkid.",
    "I'm not here to chat with streetkids.",
    "I shut down on talks with streetkids.",
    "Not interested in a streetkid's voice.",
    "I won't respond to a streetkid, walk away.",
    "I'm done talking to streetkids.",
    "No discussion with your kind, clear off.",
    "Don't try to get a word from me, streetkid.",
    "I'm not listening to a streetkid, go.",
    "Hands off conversation, streetkid, leave now.",
    "You grew up on these streets, don't preach to me.",
    "You talk like you own Night City, but you still sleep in alleys.",
    "Seen you around, stay off my turf.",
    "You think you're clever because you know the blocks? Go.",
    "Don't bring your street reputation here.",
    "You and your crew don't belong on this corner.",
    "Keep your hustles to your neighborhood.",
    "You waste time bragging about old scores, move.",
    "Don't pull your stunts here, kid.",
    "Save your stories for someone who cares.",
    "You play tough where you grew up, not here.",
    "Your street contacts don't mean anything here.",
    "Take your petty deals elsewhere.",
    "You look for trouble, but this isn't your beat.",
    "Stop acting like a local kingpin, walk away.",
    "Don't drag your turf here, keep it in your district.",
    "You grew up in the gutters; stay there.",
    "Your corner tricks don't fly on this block.",
    "You think Night City owes you? It doesn't.",
    "Go back to where you learned to hustle."
}
function CyberNPC.NPCByeStreetKidHostileLinesRandomLine()
    local line = math.random(#(CyberNPC.NPCByeStreetKidHostileLines))
    return CyberNPC.NPCByeStreetKidHostileLines[line]
end
...
function CyberNPC.NPCSpeak(textContent, npcId, npcName, additionalArgs)
    ...
    local textContentWaitTime = CyberNPC.subtitlesControl.CalcTimeOfString(
        textContent
    )+2
    CyberNPC.NPCLookAtPlayer(textContentWaitTime)
    CyberNPC.backend.Tts(
        textContent,
        npcId, 
        '',
...
function CyberNPC.IsTalkable(target)
    local player = Game.GetPlayer()
    if target then
        return AIControl.InTalkDistance(player, CyberNPC.GetLastTarget())
    else
        return AIControl.InTalkDistance(player, target)
    end
end
